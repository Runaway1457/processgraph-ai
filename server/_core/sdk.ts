...
class OAuthService {
  constructor(private client: ReturnType<typeof axios.create>) {
    if (!ENV.oAuthServerUrl) {
      console.info("[Auth] External OAuth is disabled.");
    } else {
      console.info("[Auth] External OAuth adapter enabled.");
    }
  }
...
class SDKServer {
  ...
  /**
   * Create a session token for an authenticated user's external ID.
   * @example
